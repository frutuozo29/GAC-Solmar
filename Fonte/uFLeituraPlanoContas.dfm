inherited fLeituraPlanoContas: TfLeituraPlanoContas
  BorderIcons = [biSystemMenu, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Leitura Plano de Contas'
  ClientHeight = 405
  ClientWidth = 779
  ...
  object dsPlanoDeContas: TDataSource
    DataSet = DMPlanodeContas.QueryImportacao
    Left = 504
    Top = 152
  end
